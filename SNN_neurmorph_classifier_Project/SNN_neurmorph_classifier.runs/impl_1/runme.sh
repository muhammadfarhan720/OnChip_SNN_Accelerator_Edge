...
HD_PWD='E:/advanced_analog_IC_Spring2024/Gauri_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LSM_reservoir.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LSM_reservoir.tcl -notrace
